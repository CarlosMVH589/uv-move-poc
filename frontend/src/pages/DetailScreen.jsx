...
export default function DetailScreen({ navigate }) {
  return (
    <div className="uvm-detail">
      ...
      <div className="uvm-detail__body">
        <div className="uvm-detail__hero">
          <IconBike size={80} color="#1a4fa0" />
          <h2 className="uvm-detail__hero-name">BICICLETA #B102</h2>
        ...
        <div className="uvm-card uvm-detail__info-card">
          <InfoRow label="UBICACIÓN" value="Estación Central" />
          <div className="uvm-card-divider" />
          <InfoRow label="TIPO" value="Bicicleta Urbana" />
          <div className="uvm-card-divider" />
        ...
        <div className="uvm-detail__cta">
          <button className="uvm-btn-primary uvm-btn-primary--lg" onClick={() => navigate("confirmed")}>
            RESERVAR AHORA
          </button>
        </div>
      </div>
