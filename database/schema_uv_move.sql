...
CREATE TABLE vehiculos (
    ...
    estado_operativo VARCHAR(30) NOT NULL, -- Valores esperados: 'Disponible', 'En_Revision', 'Reservado'
...
CREATE TABLE reservaciones (
    ...
    id_usuario VARCHAR(50) NOT NULL, -- Vinculado lógicamente con Supabase Auth
    fecha_inicio TIMESTAMP NOT NULL,
    estado_reserva VARCHAR(30) NOT NULL, -- 'Activa', 'Completada', 'Cancelada'
